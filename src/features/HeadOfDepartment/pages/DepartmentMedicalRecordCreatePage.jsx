    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            if (fetchedMedicalRecord) {
                ...
                navigate(`/hod/medical-records/${fetchedMedicalRecord.id}/form`, { replace: true });
                return; 
            }
    ...
    const onMedicalRecordFormSubmit = async (formData) => { // Đổi tên 'data' thành 'formData' cho rõ
        ...
        try {
            ...
            const responseMedicalRecord = await axiosInstance.post(
                `/hod/appointments/${appointment.id}/medical-records`, 
            ...
            // --- BƯỚC 3: ĐIỀU HƯỚNG ---
            navigate(`/hod/medical-records/${newMedicalRecordId}/form`, { replace: true });
