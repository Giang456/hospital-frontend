...
const MedicalRecordDetailPage = () => {
    ...
    const fetchMedicalRecordDetails = async () => {
        ...
        setError(null);
        try {
            const response = await axiosInstance.get(`/hod/medical-records/${recordId}`, {
    ...
    const handleSubmitPrescription = async () => {
        ...
        try {
            ...
            const response = await axiosInstance.post(`/hod/medical-records/${medicalRecord.id}/prescriptions`, payload);
    ...
    if (error) {
        return (
            <Container className="my-4">
                ...
                <Button variant="secondary" onClick={() => navigate('/hod/medical-records')} className="mt-3">
    ...
    return (
        <Container className="my-4">
            <Button variant="secondary" onClick={() => navigate('/hod/medical-records')} className="mb-3">
                ← Quay lại lịch sử khám
            </Button>
